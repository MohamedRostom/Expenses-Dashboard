...
- Manual preview pass of PR #10 done by Rostom (2026-09-25). Next action: get `ci` green on PR #10 (the FR-001 e2e fix `a22b621` is unpushed), merge, then tag `v0.1.0` (T116). Still open in 001 and owner-only: T119 execute the Cloudflare cutover (Stage 2, post-beta), T123 people-based checks SC-006/SC-009, T124 accept ADR-0001/0002 (email = Resend decided; name, licence, analytics pending).
